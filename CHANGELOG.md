...
- Tighten canonical ledger key validation to zero-or-non-leading-zero non-negative safe-integer text; every other bare numeric text (leading zeros, signs, whitespace, decimals, exponents) is flagged for rebuild.
