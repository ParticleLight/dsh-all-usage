...
- Reject upstream catalogs beyond a hard candidate ceiling instead of sorting an unbounded entry list; the 10k entry cap still applies deterministically within the ceiling.
