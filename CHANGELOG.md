...
- Compare catalog keys and conflict groups by code unit instead of locale, so composed/decomposed Unicode ties cannot let upstream enumeration order decide the surviving entry.
